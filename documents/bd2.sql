...
INSERT IGNORE INTO `user` (`id`, `email`, `roles`, `password`, `is_verified`, `pseudo`, `avatar`, `registration_date`, `last_login_date`, `author_infos`, `is_published`, `last_profil_edit_time`) VALUES
	...
	(6, 'jean@sfr.fr', '["ROLE_USER"]', '$2y$13$iRGeVSNjBDG5UAa.H5yqMOlpR7d3Ru1laUAeyOk6OKxgEkgWj.T1O', 1, 'jean', NULL, NULL, NULL, NULL, NULL, NULL),
	(7, 'dog@sfr.fr', '["ROLE_USER"]', '$2y$13$wcrQK/6ftSxKzIf2qxlsB.h8/JXa/0Yu/vShTfITJ5R.44ibPMLCy', 0, 'dog', NULL, NULL, NULL, NULL, NULL, NULL);
