...
-- Listage des données de la table rainbowlog.alert : ~2 rows (environ)
...
INSERT INTO `contact` (`id`, `sender_id`, `receiver_id`, `date_message`, `seen`, `text`) VALUES
	...
	(12, 5, 9, '2024-10-11 21:27:10', NULL, 'Hello Cat!'),
	(13, 3, 7, '2024-10-11 21:43:31', NULL, 'Hello Fish'),
	(14, 1, 9, '2024-10-12 18:11:37', NULL, 'Hello Cat! I\'ll absent tomorrow'),
...
-- Listage des données de la table rainbowlog.evaluation : ~10 rows (environ)
...
-- Listage des données de la table rainbowlog.experience : ~22 rows (environ)
...
-- Listage des données de la table rainbowlog.photo : ~10 rows (environ)
...
INSERT INTO `user` (`id`, `email`, `roles`, `password`, `is_verified`, `pseudo`, `avatar`, `registration_date`, `last_login_date`, `author_infos`, `new_messages`, `last_profil_edit_time`, `is_blocked`, `rating`) VALUES
	(1, 'admin@rainbowlog.com', '["ROLE_ADMIN"]', '$2y$13$qio8vEFnypfctlY3MAdI3.fdkgUoGXSFpQvUVIlZdjh.8GBeuw6a.', 1, 'admin', NULL, NULL, NULL, NULL, 0, '2024-09-30 14:35:11', 0, NULL),
	...
	(9, 'cat@sfr.fr', '["ROLE_USER"]', '$2y$13$COyESmMz9tm6GnoD2tgyq.p3nUmQWfnYX1si4Hd9eNdc//cFvqwWS', 1, 'Cat', NULL, NULL, NULL, NULL, 0, NULL, 0, NULL);
