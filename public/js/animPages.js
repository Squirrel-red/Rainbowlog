...
if (document.getElementById('event-show')) {
    ...
    $(document).ready(function() {
        ...
        $(window).scroll(function() {
            $('#text-gallery:not(.visible), .photographer-container:not(.visible) ').each(function() {
...
// ^ ANIMATION FOR PHOTOGRAPHER (SHOW) PAGE
if (document.getElementById('photographer-show')) {
    ...
    document.addEventListener('DOMContentLoaded', function() {
        const detailsEvent = document.getElementById('photographer-detail');
        const quote = document.getElementById('quote');
        const quoteText = document.getElementById('quote-text');
        ...
        function animateDetailsEvent() {
            ...
            if (isElementInViewport(detailsEvent)) {
                ...
                // Animation of the quote appearing with a slide-in from the right
                gsap.fromTo(quote, { x: 100, opacity: 0 }, { x: 0, opacity: 1, duration: 1 });
