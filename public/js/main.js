...
const shadowHeader = () => {
  ...
  // when the scroll is greater than 50 viewport height, add the scroll-header class to the header tags
  this.scrollY >= 50
...
const scrollUp = () => {
  ...
  // when the scroll is higher than 350 viewport hight, add the show-scroll class to the a tag with the scrollup class
  this.scrollY >= 350
